    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-blue-50 to-white dark:from-[#0f2027] dark:via-[#203a43] dark:to-[#2c5364]">
      <div className="max-w-md w-full space-y-6 bg-white dark:bg-black bg-opacity-90 dark:bg-opacity-80 rounded-2xl shadow-2xl p-10 backdrop-blur-md border border-blue-200 dark:border-blue-800">
        <div className="flex justify-between items-center">
          <h2 className="text-3xl font-extrabold text-gray-800 dark:text-blue-200 tracking-wider">Sign Up</h2>
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full cursor-pointer bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-blue-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
          >
            {theme === 'dark' ? '☀️' : '🌙'}
          </button>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600 dark:text-blue-200">
            ...
            <Link to="/login" className="font-medium text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-white">
              Login
            </Link>
          </p>
        </div>
